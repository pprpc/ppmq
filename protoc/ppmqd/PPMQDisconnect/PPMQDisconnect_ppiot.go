...
type PPMQDisconnectClient interface {
	PPCall(ctx context.Context, in *Req) (*Resp, *packets.CmdPacket, error)
}

type pPMQDisconnectClient struct {
	cc pprpc.RPCCliConn
}

func NewPPMQDisconnectClient(cc pprpc.RPCCliConn) PPMQDisconnectClient {
	return &pPMQDisconnectClient{cc}
}

func (c *pPMQDisconnectClient) PPCall(ctx context.Context, in *Req) (*Resp, *packets.CmdPacket, error) {
